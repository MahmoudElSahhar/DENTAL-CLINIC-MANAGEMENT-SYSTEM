    ...
    <script>
        function testing(str) {
            ...
            if(str != ""){
                ...
                xhttp.open("GET", "test.php?docID="+str, true);
                xhttp.send();
            }
        }
    </script>
        ...
        <?php
            ...
            echo "
                <form action='' method='post'>
                    ...
                    <select name='DoctorID' class='form-control col-sm-3' onchange='testing(this.value)'>";
            ...
            if(isset($_POST['searchDoctor'])){
                ...
                //$doctorID = $_POST['DoctorID'];
                //$visitDuration = $_POST['visitDuration'];
                $s = readSchedule($doctorID);
                $e = readExcuseForPatient($doctorID);
                $appoints = databaseAppointmentsReader($doctorID);
